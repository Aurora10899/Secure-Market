...
export function Footer() {
  return (
    <section className="overflow-hidden py-10 bg-violet-900">
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-5/12">
            <div className="flex h-full flex-col justify-between">
              <div className="mb-4 inline-flex items-center">
                ...
                <span className="ml-4 text-lg font-bold">Secure Market</span>
              </div>
              <div>
                <p className="mb-4  text-base font-medium">A Project by Aniket Pal & Aniket Chatterjee</p>
